...
public class PointQuadtreeTest {
	...
	private PointQuadtree<Location> makeQuadTreeFor(Location... points) {
		...
		//System.out.println("TopLeftCorner (" + (westernLongitude-SLACK) + ", " + (northernLatitude+SLACK + " )"));
		//System.out.println("BottomRightCorner (" + (easternLongitude+SLACK) + ", " + (southernLatitude-SLACK) + " )");
