...
public class LeafTrieTest {
	...
	@BeforeEach
	public void setUp() {
		leaf = new LeafTrie<>(TOP_LEFT_X,TOP_LEFT_Y,BOTTOM_RIGHT_X,BOTTOM_RIGHT_Y);
		points = new HashSet<>();
	}
	...
	/**
	 * Test that a duplicate insert/replace doesn't raise an exception
	 */
	@Test  
	...
	/**
	 * A string representation, other than the default one.
	 */
	@Test
	void testToString() {

		assertFalse(leaf.toString().startsWith("@"), "LeafTrie@");
	}
